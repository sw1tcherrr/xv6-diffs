...
## Часть 5*. Ленивая аллокация (+6 баллов)
...
* Тесты `sbrkbasic` и `sbrkfail` не будут проходить после выполнения этого задания. Обратите внимание на функцию `wait` ([`kernel/proc.c:384`](kernel/proc.c#L384)).
